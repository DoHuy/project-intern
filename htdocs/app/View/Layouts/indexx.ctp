...
<html lang="vi">
  <head>
    ...
    <?php echo $this->Html->script('jquerymin'); ?><?php echo $this->Html->script('like'); ?>
  ...
  <body data-spy="scroll" data-offset="0" data-target="#navbar-main">
    ...
    <div class="navbar navbar-inverse navbar-fixed-top">
      <div class="container">
          ...
          <ul class="nav navbar-nav">
            ...
            <li><div class="dropdown">
                ...
                <div class="dropdown-content">
                    ...
                    <?php echo $this->Html->link('Photos', array('controller'=>'photos','action'=>'upload'));
                    ?>
                    <?php
                    echo $this->Html->link('Videos', array('controller'=>'videos','action'=>'upload')); ?>
                  </div>
            </div></li>
        ...
        <div id="footerwrap">
            <div class="container">
                <h4>Modified by Team A - Copyright 2017 - TMH TechLab (Internship 2017)</h4>
            </div>
        </div>
